...
public class BookPageMaker {
	...
	public BookPageMaker(int displayPageNum, BookCriteria cri, int totalCount) {
		this.displayPageNum = displayPageNum;
		this.cri = cri;
		this.totalCount = totalCount;
		calculate();
	}
<<<<<<< HEAD:eBook/src/main/java/kr/kh/ebook/pagination/BookPageMaker.java
=======
...
>>>>>>> KCL:backend_ebook/src/main/java/kr/kh/ebook/pagination/BookPageMaker.java
}

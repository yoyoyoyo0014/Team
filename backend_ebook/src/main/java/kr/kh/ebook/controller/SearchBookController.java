...
<<<<<<< HEAD:eBook/src/main/java/kr/kh/ebook/controller/SearchBookController.java

=======
		System.out.println("category : " + category +", country : "+country+", genre : " + genre +", search : " + search+" 페이지 : "+count);
>>>>>>> KCL:backend_ebook/src/main/java/kr/kh/ebook/controller/SearchBookController.java

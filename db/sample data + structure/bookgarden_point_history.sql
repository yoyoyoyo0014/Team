...
CREATE TABLE `point_history` (
  ...
  `ph_bu_num` int NOT NULL,
  `ph_point` int NOT NULL,
  PRIMARY KEY (`ph_num`),
  KEY `FK_member_TO_point_History_1` (`ph_me_id`),
  KEY `FK_buy_TO_point_History_1` (`ph_bu_num`),
  CONSTRAINT `FK_buy_TO_point_History_1` FOREIGN KEY (`ph_bu_num`) REFERENCES `buy` (`bu_num`),
  CONSTRAINT `FK_member_TO_point_History_1` FOREIGN KEY (`ph_me_id`) REFERENCES `member` (`me_id`)

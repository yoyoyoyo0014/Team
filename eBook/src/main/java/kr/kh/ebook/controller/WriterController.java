...
public class WriterController {
	...
	public List<WriterVO> selectWriterList(@PathVariable("bookNum") int bookNum) {
	...
	//책 쓴 작가가져오기
	@GetMapping("/selectWriterBookList/{bookNum}")
	public List<WriterListVO> selectWriterBook(@PathVariable("bookNum") int bookNum) {
		List<WriterListVO> res = writerService.selectWriterList(bookNum);
		return res;
	}

  ...
  return (
    <div className="container">
      ...
      <div className="insert">
        ...
        {user?.me_authority === 'ADMIN' && co_num == 1 ? <Link className="btn btn-outline-primary" style={{ marginBottom: '20px', float: 'right' }} to={`/post/insert/${co_num}`}>글쓰기</Link> : ''}
        {user?.me_authority === 'USER' && co_num != 3 && co_num != 1 ? <Link className="btn btn-outline-primary" style={{ marginBottom: '20px', float: 'right' }} to={`/post/insert/${co_num}`}>글쓰기</Link> : ''}
      </div>
